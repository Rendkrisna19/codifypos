<header class="bg-[#fcfcfc] dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 h-16 flex items-center justify-between px-6 sticky top-0 z-30 transition-colors duration-300 no-print">
    ...
    <div class="flex items-center gap-6">
        ...
        <div class="flex items-center gap-3">
            ...
            @if(auth()->user()->profile_photo)
                <img src="{{ asset('storage/' . auth()->user()->profile_photo) }}" alt="Profile" class="w-9 h-9 rounded-full object-cover border border-gray-200 dark:border-gray-700 shadow-sm bg-white">
            @else
                <div class="w-9 h-9 rounded-full bg-[#111111] dark:bg-white text-white dark:text-[#111111] flex items-center justify-center font-bold shadow-sm transition-colors duration-300 border border-gray-200 dark:border-gray-700">
